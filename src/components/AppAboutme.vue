    ...
    const timelineES = ref([
      ...
      },
      {
        ...
        text: [
          ...
          "Paralelamente completé el curso ONE Tech Foundation G8 – Back End (Alura/Oracle, 2025) y el curso de Análisis de Datos de Google, certificaciones que fortalecieron mis habilidades en desarrollo backend y manejo de datos. Continúo mejorando mi nivel de inglés y ampliando mis conocimientos en herramientas TIC."
        ]
      }
    ])
    ...
    const timelineEN = ref([
      ...
      },
      {
        ...
        text: [
          ...
          "In parallel I completed the ONE Tech Foundation G8 – Back End course (Alura/Oracle, 2025) and the Google Data Analytics certificate, both of which strengthened my backend development and data handling skills. I continue improving my English level and expanding my knowledge in ICT tools."
        ]
      }
    ])
